...
function useredit_shared_definition(&$mform, $editoroptions, $filemanageroptions, $user) {
    ...
    ## Code made by vraj@mrccsolutions.com-------------------------------
    $userstatus = array('Select user status...');
    $userstatus['1'] = "Interview Candidate";
    $userstatus['2'] = "Employee";
    $userstatus['3'] = "Sub-contractor";
    $userstatus['4'] = "Others";
    $mform->addElement('select', 'userstatus', get_string('userstatus', 'tool_uploaduser'), $userstatus);
    $mform->addRule('userstatus', 'userstatus', 'required', null, 'client');
    ##----------------------------------------------------------------------
