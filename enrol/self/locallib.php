...
##vraj@mrccsolution.com---------------------------------------------------------------------------------
        $userstatus_enrol = $DB->get_record('user',['id'=>$USER->id]);
        $userstatus = $userstatus_enrol->userstatus;
        $coursename = $DB->get_record('course',['id'=>$this->instance->courseid]);
        $categoryname = $DB->get_record('course_categories',['id'=>$coursename->category]);
        $catevalue = $categoryname->userstatus;//array_search($categoryname->name,$catename,true);
        if($userstatus == $catevalue){
            $this->add_action_buttons(false, get_string('enrolme', 'enrol_self'));
        }else{
            $mform->addElement('html', '<div>');
            $mform->addElement('static', 'userstatusmsg',"Enrollment Denied !!");
            $mform->addElement('html', '</div>');
        }
